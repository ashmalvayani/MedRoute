...
from datasets_my.deeplesion_dataset import DeepLesionDataset

BASE_URL = os.getenv("BASE_URL", "http://localhost:8000")
JUDGE_BASE_URL = os.getenv("JUDGE_BASE_URL", os.getenv("BASE_URL", "http://localhost:8001"))
API_KEY = os.getenv("API_KEY", "EMPTY")
RESULT_DIR = Path("result/deeplesion_baseline")
...
async def main_async(args):
    ...
    print(f"Dataset: DeepLesion test — {len(records)} questions")
...
def main():
    p = argparse.ArgumentParser(description="DeepLesion baseline evaluation (no routing)")
