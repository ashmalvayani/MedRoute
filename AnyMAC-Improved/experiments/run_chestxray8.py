"""
AnyMAC-Improved: Entry point for ChestX-ray8 router training and evaluation.
...
from GDesigner.prompt.chestxray8_prompt_set import SPECIALISTS
from GDesigner.utils.const import GDesigner_ROOT
from GDesigner.utils.globals import Time

try:
    from GDesigner.domain.chestxray8_domain import ChestXray8Domain
except Exception:
    ChestXray8Domain = None  # type: ignore
...
def main():
    p = argparse.ArgumentParser(description="AnyMAC-Improved ChestX-ray8 Router")

    p.add_argument("--result_dir", type=str, default="result/chestxray8_img_embed")
    ...
    p.add_argument('--domain', type=str, default="chestxray8")
