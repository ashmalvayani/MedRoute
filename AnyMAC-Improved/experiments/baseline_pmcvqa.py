...
async def main_async(args):
    ...
    print(f"Dataset: PMC-VQA test — {len(records)} questions")
...
def main():
    p = argparse.ArgumentParser(description="PMC-VQA baseline evaluation (no routing)")
