"""
AnyMAC-Improved: Entry point for DeepLesion router training and evaluation.
...
from GDesigner.prompt.deeplesion_prompt_set import SPECIALISTS
from GDesigner.utils.const import GDesigner_ROOT
from GDesigner.utils.globals import Time

try:
    from GDesigner.domain.deeplesion_domain import DeepLesionDomain
except Exception:
    DeepLesionDomain = None  # type: ignore
...
def main():
    p = argparse.ArgumentParser(description="AnyMAC-Improved DeepLesion Router")

    p.add_argument("--result_dir", type=str, default="result/deeplesion_img_embed")
    ...
    p.add_argument('--domain', type=str, default="deeplesion")
