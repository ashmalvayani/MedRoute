...
RESULT_DIR = Path("result/btmri_baseline")
...
async def main_async(args):
    ...
    print(f"Dataset: BTMRI test — {len(records)} questions")
...
def main():
    p = argparse.ArgumentParser(description="BTMRI baseline evaluation (no routing)")
