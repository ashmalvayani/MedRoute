...
try:
    ...
    gsm_get_predict = None  # gsm8k not used in text-only setup

@AgentRegistry.register('MathSolver2')
class MathSolver2(Node):
    def __init__(self, id: str | None =None, role:str = None ,domain: str = "", llm_name: str = "",):
        super().__init__(id, "MathSolver2" ,domain, llm_name)
