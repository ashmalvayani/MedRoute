#!/usr/bin/env bash
# PMC-VQA ablation: DM chain-of-thought reasoning with 27B captions
#   - Uses --dm_cot: DM reasons before answering (both train + eval)
#   - With hints
...
#
# Usage:
#   bash scripts/train_pmcvqa_dm_cot.sh
set -eo pipefail
...
RESULT_DIR="result/pmcvqa_dm_cot_train"
ENTROPY_BETA=0.05
EVAL_LIMIT=2100
EVAL_TEMPS="0.5"
...
echo "============================================"
echo "  PMC-VQA DM Chain-of-Thought Training"
...
echo "  Improvements: dynamic_pool + dynamic_prompts + dm_cot"
