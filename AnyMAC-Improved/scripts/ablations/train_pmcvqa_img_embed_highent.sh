#!/usr/bin/env bash
# Image embedding routing with L2 norm — higher entropy beta (0.15) for exploration
set -eo pipefail
...
RESULT_DIR="result/pmcvqa_img_embed_highent"
ENTROPY_BETA=0.15
EVAL_LIMIT=2100
EVAL_TEMPS="0.5"
...
echo "============================================"
echo "  IMG EMBED + L2 NORM — HIGH ENTROPY (beta=$ENTROPY_BETA)"
...
echo ""
echo "============================================"
echo "  RESULTS (HIGH ENTROPY beta=$ENTROPY_BETA)"
echo "============================================"
