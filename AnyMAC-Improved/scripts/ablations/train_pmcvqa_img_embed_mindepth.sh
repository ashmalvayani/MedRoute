#!/usr/bin/env bash
# Image embedding routing with L2 norm + min routing depth 1
set -eo pipefail
...
RESULT_DIR="result/pmcvqa_img_embed_mindepth3"
ENTROPY_BETA=0.05
EVAL_LIMIT=2100
EVAL_TEMPS="0.5"
...
echo "============================================"
echo "  IMG EMBED + L2 NORM + MIN DEPTH $MIN_ROUTING_DEPTH"
...
if [ "$EXISTING_EPOCHS" -ge "$EPOCHS" ]; then
    ...
    python experiments/run_pmcvqa.py \
        ...
        --min_routing_depth "$MIN_ROUTING_DEPTH" \
...
echo ""
echo "============================================"
echo "  RESULTS (MIN DEPTH $MIN_ROUTING_DEPTH)"
echo "============================================"
