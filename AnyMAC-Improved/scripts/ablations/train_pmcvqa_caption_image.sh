#!/usr/bin/env bash
# Image embedding + caption fusion: text_question + caption_embed + image_embed
set -eo pipefail
...
RESULT_DIR="result/pmcvqa_caption_image"
ENTROPY_BETA=0.05
EVAL_LIMIT=2100
EVAL_TEMPS="0.5"
EVAL_PARALLELISM=128
SEED=99
FUSION_MODE="caption_image"
...
echo "============================================"
echo "  CAPTION + IMAGE FUSION (${FUSION_MODE})"
...
echo ""
echo "============================================"
echo "  RESULTS (CAPTION + IMAGE FUSION)"
echo "============================================"
