#!/usr/bin/env bash
# MedQA ablation: dynamic pool + dynamic prompts, 32B consistent (all Qwen3-32B)
#
# This tests whether using a consistent 32B model for everything
# (pool generation, dynamic prompts, specialist reasoning) improves over
# the 8B-specialist + 32B-judge setup.
#
# Requirements:
...
RESULT_DIR="result/dynamic_pool_32b"
ENTROPY_BETA=0.05
EVAL_LIMIT=1500
EVAL_TEMPS="0.7"
...
echo "============================================"
echo "  Dynamic Specialist Pool Training (32B Consistent)"
