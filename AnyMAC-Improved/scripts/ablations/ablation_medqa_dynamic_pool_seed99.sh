#!/usr/bin/env bash
# MedQA: Dynamic pool + Dynamic prompts with seed=99 (different 300 training questions)
set -eo pipefail
...
RESULT_DIR="result/ablation_medqa_dynamic_pool_seed99"
ENTROPY_BETA=0.05
EVAL_LIMIT=1500
EVAL_TEMPS="0.7"
SEED=99
...
echo "============================================"
echo "  MedQA Dynamic Pool + Dynamic Prompts (seed=$SEED)"
...
echo ""
echo "============================================"
echo "  RESULTS: MedQA Dynamic Pool + Dynamic Prompts (seed=$SEED)"
echo "============================================"
