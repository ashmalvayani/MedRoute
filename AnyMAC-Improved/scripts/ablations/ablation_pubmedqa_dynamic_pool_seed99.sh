#!/usr/bin/env bash
# Ablation 2: Dynamic pool + Dynamic prompts (seed=99, different 300 questions)
set -eo pipefail
...
RESULT_DIR="result/ablation_pubmedqa_dynamic_pool_seed99"
ENTROPY_BETA=0.05
EVAL_LIMIT=1100
EVAL_TEMPS="0.7"
SEED=99
...
echo "============================================"
echo "  Ablation 2: Dynamic Pool + Dynamic Prompts (seed=$SEED)"
...
echo ""
echo "============================================"
echo "  RESULTS: Dynamic Pool + Dynamic Prompts (seed=$SEED)"
echo "============================================"
