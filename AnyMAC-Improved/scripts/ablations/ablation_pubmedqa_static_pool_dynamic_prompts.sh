#!/usr/bin/env bash
# Ablation 3: Static pool + Dynamic prompts
set -eo pipefail
...
RESULT_DIR="result/ablation_pubmedqa_static_pool_dynamic_prompts"
ENTROPY_BETA=0.05
EVAL_LIMIT=1100
EVAL_TEMPS="0.7"
...
echo "============================================"
echo "  Ablation 3: Static Pool + Dynamic Prompts"
...
echo ""
echo "============================================"
echo "  RESULTS: Static Pool + Dynamic Prompts"
echo "============================================"
