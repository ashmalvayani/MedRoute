#!/usr/bin/env bash
# Ablation 1: Static pool + NO dynamic prompts (baseline)
set -eo pipefail
...
RESULT_DIR="result/ablation_pubmedqa_static_pool"
ENTROPY_BETA=0.05
EVAL_LIMIT=1100
EVAL_TEMPS="0.7"
...
echo "============================================"
echo "  Ablation 1: Static Pool + No Dynamic Prompts"
...
echo ""
echo "============================================"
echo "  RESULTS: Static Pool + No Dynamic Prompts"
echo "============================================"
