#!/usr/bin/env bash
# PMC-VQA training: SigLIP image embeddings + L2 norm for GNN routing, DM CoT, Qwen3.5-9B + Qwen3.6-27B
# Usage:
...
RESULT_DIR="result/pmcvqa_img_embed"
ENTROPY_BETA=0.05
EVAL_LIMIT=2100
EVAL_TEMPS="0.5"
...
echo "============================================"
echo "  PMC-VQA Image Embedding Routing Training"
...
echo "  path override: ${TRAIN_JSON_PATH:-none} | ${TEST_JSON_PATH:-none} (optional; default is Medsets)"
