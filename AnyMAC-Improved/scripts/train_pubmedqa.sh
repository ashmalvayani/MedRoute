#!/usr/bin/env bash
# PubMedQA training: dynamic pool + dynamic prompts, Qwen3-8B base + Qwen3-32B judge
#
# Usage:
#   bash scripts/train_pubmedqa_dynamic_pool.sh
set -eo pipefail
...
RESULT_DIR="result/pubmedqa_dynamic_pool"
ENTROPY_BETA=0.05
EVAL_LIMIT=1100
EVAL_TEMPS="0.7"
SEED=99
...
echo "============================================"
echo "  PubMedQA Dynamic Specialist Pool Training"
...
echo "  Baseline     : bash scripts/run_baseline_pubmedqa.sh"
echo "============================================"
