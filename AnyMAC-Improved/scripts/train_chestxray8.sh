...
RESULT_DIR="result/chestxray8_img_embed_v2"
ENTROPY_BETA=0.05
EVAL_LIMIT=2000
EVAL_TEMPS="0.5"
...
echo "============================================"
echo "  ChestX-ray8 Image Embedding Routing Training"
...
echo "  path override: ${TRAIN_JSON_PATH:-none} | ${TEST_JSON_PATH:-none} (optional .json / .csv; default is Medsets)"
...
if [ "$EXISTING_EPOCHS" -ge "$EPOCHS" ]; then
    ...
    python experiments/run_chestxray8.py \
        --llm_name "$MODEL" \
