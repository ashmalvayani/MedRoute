...
LOG="$REPO_DIR/logs/baseline_pmcvqa_${TIMESTAMP}.log"
...
{
    echo "========================================"
    echo "  AnyMAC-Improved baseline eval (PMC-VQA)"
    echo "  Started      : $(date)"
    ...
    echo "  Seed         : $SEED"
    echo "  train_json   : ${TRAIN_JSON_PATH:-(unset; default Medsets, then packaged PMC-VQA CSV)}"
    ...
    python experiments/baseline_pmcvqa.py \
        --model "$MODEL" \
...
echo "Results directory: $REPO_DIR/result/pmcvqa_baseline/"
